package btech.JAVA_AWT.Project_MAths_java;
...
public  class code {
    ...
    /////////////////////////////////////////////////////////////
    static void column_wise(int[][] array , int row , int column){
        int sum =0 ;                                                // column wise sum method
    ...
    static void cosec(){                                                  //Tan X value calculator method
        ...
        double x= sc.nextDouble();
        double cosecValue = (1/Math.sin(Math.toRadians(x)));
        System.out.println(Green+"Cosec(" + x + ") in Degrees is "+RESET + cosecValue);
        System.out.println(Green+"~~~~~~~~~~~"+RESET);
        System.out.println(Green+"Cosec(" + x + ") in Radian is "+RESET + (1/Math.sin(x)));
    }
